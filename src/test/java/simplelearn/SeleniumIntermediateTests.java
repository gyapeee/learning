...
/**
 * <p>Base page of the examples: https://www.simplilearn.com/tutorials/selenium-tutorial/selenium-interview-questions-and-answers#intermediate_level_selenium_interview_questions</p>
 *
...
public class SeleniumIntermediateTests {
    @Test
    void TC_12_How_to_type_text_in_an_input_box_using_Selenium() {

    }

    @Test
    void TC_13_How_to_click_on_a_hyperlink_in_Selenium() {

    }

    @Test
    void TC_14_How_to_scroll_down_a_page_using_JavaScript() {

    }

    @Test
    void TC_15_How_to_assert_the_title_of_a_webpage() {

    }

    @Test
    void TC_16_How_to_mouse_hover_over_a_web_element_() {
    ...
    @Test
    void TC_18_What_is_POM_Page_Object_Model() {
    ...
    @Test
    void TC_20_How_does_Selenium_handle_Windows_based_pop_ups() {

    }

    @Test
    void TC_21_How_to_take_screenshots_in_WebDriver() {
